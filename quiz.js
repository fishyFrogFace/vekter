...
alternatives =
  '<input type="radio" name="opt" id="a"><label id="lbla" for="a">option 1</label><br>' +
...
function makeQuiz(set, title) {
  ...
  document.getElementById("header2").innerHTML =
    "Det finnes " +
    set.length +
    " spørsmål i denne kategorien. Du vil få maksimalt " +
    (questions - 1) +
    " spørsmål";
...
function endQuiz() {
  document.getElementById("options").innerHTML =
    "Dersom du ønsker å ta en ny test, kan du laste inn siden på nytt.";
  document.getElementById("button").innerHTML = "";
  document.getElementById("header2").innerHTML =
    "Du fikk " +
    count +
